...
try {
    ...
    if (!serviceAccountPath) {
        throw new Error('FIREBASE_SERVICE_ACCOUNT_PATH environment variable is not set. Please set it to the path of your Firebase service account JSON file.');
    }
    ...
    console.error("Critical Error: Failed to load or parse Firebase service account key from file:", error.message);
